...
const char* ssid = "Nazareth";
const char* password = "Naza_0404";
...
//API KEY
const String privateKey = "c09610f29043884426d34b28b2347560";
...
float coord_lon = root["coord"]["lon"]; // -98.37
float coord_lat = root["coord"]["lat"]; // 20.08
